...
namespace TOPLauncher
{
    ...
    {
        QString tipText = QObject::tr("Would you like to remove the user \"%1\" who logins to server \"%2\"? ").arg(m_username, m_serverName);

        if (QMessageBox::question(parentWidget(), QObject::tr("Caution"), tipText, QMessageBox::Yes, QMessageBox::No) == QMessageBox::Yes)
        {
